...
/// to the final `mobileTokenData` dictionary.
///
/// Contract:
///  - `key` must be stable for the lifetime of the record instance.
///  - `build()` should be idempotent — repeated calls must return compatible values.
