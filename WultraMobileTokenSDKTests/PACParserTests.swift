...
struct PACParserTest {

    @Test
    func testQRPACParserWithEmptyCode() {
        let code = ""
        
        #expect(WMTPACUtils.parseQRCode(code: code) == nil)
    }
    ...
    func testQRTPACParserWithValidDeeplinkCode() {
        ...
        #expect(WMTPACUtils.parseQRCode(code: code)?.totp == "73743194", "Parsing of totp failed")
        #expect(WMTPACUtils.parseQRCode(code: code)?.operationId == "6a1cb007-ff75-4f40-a21b-0b546f0f6cad", "Parsing of operationId failed")
    }
    ...
    func testQRTPACParserWithValidDeeplinkCodeAndBase64OID() {
        ...
        #expect(WMTPACUtils.parseQRCode(code: code)?.totp == "12345678", "Parsing of totp failed")
        #expect(WMTPACUtils.parseQRCode(code: code)?.operationId == "E/+DRFVmd4iZABEiM0RVZneImQARIjNEVWZ3iJkAESIzRFVmd4iZAA=", "Parsing of operationId failed")
    }
    ...
    func testQRPACParserWithValidJWT() {
        ...
        #expect(parsed?.totp == "14357458", "Parsing of totp failed")
        #expect(WMTPACUtils.parseQRCode(code: code)?.operationId == "3b9edfd2-4d82-477c-b4b3-20fa5c99c993", "Parsing of operationId failed")
    }
    ...
    func testQRPACParserWithValidJWTWithoutPadding() {
        ...
        let parsed = WMTPACUtils.parseQRCode(code: code)
        #expect(parsed?.totp == "58590059", "Parsing of totp failed")
        #expect(parsed?.operationId == "LDnIcCcDhcDwG5SKz8KygPxoOmxwtzIsos0E+HPXPyo", "Parsing of operationId failed")
    }
    ...
    func testQRPACParserWithInvalidJWT() {
        ...
        let parsed = WMTPACUtils.parseQRCode(code: code)
        #expect(parsed == nil, "Parsing of should fail")
    }
    ...
    func testDeeplinkPACParserWithInvalidURL() {
        ...
        #expect(WMTPACUtils.parseDeeplink(url: url) == nil)
    }
    ...
    func testDeeplinkPACParserWithValidJWTCode() {
        ...
        #expect(WMTPACUtils.parseDeeplink(url: url)?.totp == "14357458", "Parsing of totp failed")
        #expect(WMTPACUtils.parseDeeplink(url: url)?.operationId == "3b9edfd2-4d82-477c-b4b3-20fa5c99c993", "Parsing of operationId failed")
    }
    ...
    func testDeeplinkParserWithValidPACCode() {
        ...
        #expect(WMTPACUtils.parseDeeplink(url: url)?.totp == "56725494", "Parsing of totp failed")
        #expect(WMTPACUtils.parseDeeplink(url: url)?.operationId == "df6128fc-ca51-44b7-befa-ca0e1408aa63", "Parsing of operationId failed")
    }
    ...
    func testDeeplinkPACParserWithValidAnonymousDeeplinkQRCode() {
        ...
        #expect(WMTPACUtils.parseQRCode(code: code)?.totp == nil)
        #expect(WMTPACUtils.parseQRCode(code: code)?.operationId == "df6128fc-ca51-44b7-befa-ca0e1408aa63", "Parsing of operationId failed")
    }
    ...
    func testDeeplinkPACParserWithAnonymousJWTQRCodeWithOnlyOperationId() {
        ...
        #expect(WMTPACUtils.parseQRCode(code: code)?.totp == nil)
        #expect(WMTPACUtils.parseQRCode(code: code)?.operationId == "5ac4b3e8-926f-45f0-ae28-d1bc7e6b0496", "Parsing of operationId failed")
    }
}
