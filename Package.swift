...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/wultra/powerauth-mobile-sdk-spm.git", .upToNextMinor(from: "1.9.6")),
        .package(url: "https://github.com/wultra/networking-apple.git", .upToNextMinor(from: "1.5.2"))
    ],
    targets: [
        .target(
            name: "WultraMobileTokenSDK",
